...
macro_rules! create_matching_handler {
    ($shard_id:expr, $router:expr, $events_handler:expr, $journaling:expr, $risk_engines:expr) => {{
        ...
        move |cmd: &OrderCommand, _sequence: i64, _end_of_batch: bool| {
            ...
            if router.symbol_for_this_handler(cmd.symbol_id as u64) {
                router.process_order(&mut cmd_clone);
            }
