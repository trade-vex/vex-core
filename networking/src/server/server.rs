...
//! ## Usage
//! ```rust,no_run
//! use vex_core::server::{VexCoreServer, CoreConfig};
//!
...
impl VexCoreServer {
    ...
    fn validate_config(config: &CoreConfig) -> Result<(), ServerError> {
    ...
    fn initialize_aeron(config: &CoreConfig) -> Result<Aeron, ServerError> {
